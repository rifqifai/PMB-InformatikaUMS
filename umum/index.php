...
<head>
	<meta charset="utf-8"/>
	<title>PMB ONLINE INFORMATIKA UMS 2015</title>
	<meta content='Website Penerimaan Mahasiswa Baru (PPDB Online) Informatika UMS'/>
	
	<meta content='pmb online, pmb surakarta, informatika ums' name='KEYWORDS'/>
...
<body>
	...
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title">Penerimaan Mahasiswa Baru Online</h2>
		</hgroup>
	...
	<section id="secondary_bar">
		...
		<?php
			...
			$user 	= "<span style=\"font-weight: normal; text-decoration:none\"><b><a href=\"login.php\">Login User</a></b>&nbsp;|&nbsp; <b><a href=\"../login.php\">Login Admin</a></b>";
			}
			?>
			<p><?php echo $user; ?></p>
		</div>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
			...
			if ($sesi_umum != NULL) {
				...
				echo "<li class=\"icn_new_article\"><a href=\"?p=daftar_form&mod=add\">Pendaftaran</a></li>";
			}
			?>
